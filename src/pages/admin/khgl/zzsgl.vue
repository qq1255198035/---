                                          ...
                                          <div class="footer">
                                                <transition name="fade">
                                                      <div class="button-box" v-show= "btnShow == index" key="1">
                                                            ...
                                                            <a-button @click="$router.push({path:'/zzsxq',query:{id: item.key}})">查 看</a-button>
                                                      </div>
                                                </transition>
                                          ...
                                          <div class="footer">
                                                <transition name="fade">
                                                      <div class="button-box" v-show= "btnShow == index" key="1">
                                                            ...
                                                            <a-button type="primary" class="primary" @click="$router.push({path:'/zzsxq',query:{id: item.key}})">查 看</a-button>
                                                      </div>
                                                </transition>
...
export default {
      ...
      methods:{
            getZzsspList(condition,offset,starttime,endtime){
                  zzsspList(condition,offset,starttime,endtime).then(res=>{
                        if (res.code == 1000) {
            ...
            loadMore1(){
                  ...
                  this.offset1++;
                  zzsspList('',this.offset1,'','').then(res=>{
                        if (res.code == 1000) {
            ...
            loadMore2(){
                  this.loadingMore = true;
                  this.offset2++;
                  zzsspList('',this.offset2,'','').then(res=>{
                        if (res.code == 1000) {
            ...
            handleOk(e) {
                  ...
                  this.postSponsorApproval(this.key, this.reason, 1)
            },
            handleCancel(e) {
                  this.visible = false
            },
