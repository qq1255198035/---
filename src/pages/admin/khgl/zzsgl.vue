                                          ...
                                          <div class="footer">
                                                <transition name="fade">
                                                      <div class="button-box" v-show= "btnShow == index" key="1">
                                                            ...
                                                            <a-button @click="$router.push({path:'/khgl/zzsxq',query:{id: item.key}})">{{$t('issuer.hdgl.examine')}}</a-button>
                                                      </div>
                                                </transition>
                                          ...
                                          <div class="footer">
                                                <transition name="fade">
                                                      <div class="button-box" v-show= "btnShow == index" key="1">
                                                            ...
                                                            <a-button type="primary" class="primary" @click="$router.push({path:'/khgl/zzsxq',query:{id: item.key}})">{{$t('issuer.hdgl.examine')}}</a-button>
                                                      </div>
                                                </transition>
