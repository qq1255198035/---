                                          ...
                                          <div class="footer">
                                                <transition name="fade">
                                                      <div class="button-box" v-show= "btnShow == index" key="1">
                                                            ...
                                                            <a-button @click="$router.push({path:'/jjrxq',query:{id: item.key}})">查 看</a-button>
                                                      </div>
                                                </transition>
                                          ...
                                          <div class="footer">
                                                <transition name="fade">
                                                      <div class="button-box" v-show= "btnShow == index" key="1">
                                                            ...
                                                            <a-button type="primary" class="primary" @click="$router.push({path:'/jjrxq',query:{id: item.key}})">查 看</a-button>
                                                      </div>
                                                </transition>
