          ...
          <div class="my-tab-content">
            <ul>
              <li :class="{'active': activeIndex == 1}" @click="activeIndex = 1">
                <a-icon type="property-safety"></a-icon>赞助商
              </li>
              <li :class="{'active': activeIndex == 2}" @click="activeIndex = 2">
                <a-icon type="code-sandbox"></a-icon>搞手
              </li>
              <li :class="{'active': activeIndex == 3}" @click="activeIndex = 3">
                <a-icon type="usergroup-add"></a-icon>经纪人
              </li>
            </ul>
            <div class="bottom">
              <a-button type="primary" @click="goRegister" class="my-btn">注册</a-button>
    ...
    getCaptcha(e) {
      ...
      validateFields(['email'], { force: true }, (err, values) => {
        ...
        if (!err) {
          ...
          getSmsCaptcha({ username: values.email })
            .then(res => {
              console.log(res)
              if (res.status == 203) {
