...
export const asyncRouterMap = [
         {
           ...
           children: [
             ...
             // 我的活动
             {
               path: '/activies',
               name: 'activies',
               redirect: '/activies/hogl',
               component: PageView,
               meta: { title: '我的活动', keepAlive: true, icon: 'team', permission: ['dashboard'] },
               children: [
                 {
                   path: '/activies/hdgl',
                   name: 'hdgl',
                   component: () => import('@/pages/Issuer/activies/hdgl'),
                   meta: { title: '活动管理', keepAlive: false, permission: ['dashboard'] }
                 },
                 {
                   path: '/activies/zzgl',
                   name: 'zzgl',
             ...
             },
             {
               ...
               meta: { title: '申请记录', keepAlive: true, icon: bxAnaalyse, permission: ['index'] }
             },
             {
               path: '/xxtz',
               name: 'xxtz',
